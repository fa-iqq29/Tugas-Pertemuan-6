...
public class Delete extends javax.swing.JDialog {
    ...
    public Delete(Frame parent, boolean modal, String kodeLama, String namaLama, String semesterLama, String dosenLama) {
        super(parent, modal);
        initComponents();
        connect();
        ...
        jLabel1.setText(kodeLama + " - " + namaLama +  " - " + semesterLama +  " - " + dosenLama );
    }
